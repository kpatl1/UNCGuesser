...
struct ContentView: View {
        ...
        ZStack {
            ...
            VStack {
                ...
                VStack(spacing: 15) {
                    ...
                    Button(action: {verify(scoreCount: scoreCount, score: score)}) {
                            Text("Confirm")
                            .padding()
                            .font(.subheadline)
                            .foregroundColor(.white)
    ...
    func verify(scoreCount: Int, score: [Int]){
        ...
        if mapLocations.count != 0 {
            ...
            var lat = (1000*(abs(mapLocations[0].latitude - locationsDict[locations[correctAnswer]]![0])))
            var long = (1000*(abs(mapLocations[0].longitude - locationsDict[locations[correctAnswer]]![1])))
